...
const App = () => {
  ...
  return <>
    <Routes>
      ...
      <Route path="/editor" element={<Pages.EditorProject />} />
      <Route path="/editorExpression" element={<Pages.EditorExpressions/>} />
      {/* <Route path="/about" element={<Pages.About />} />
      <Route path="/privacy" element={<Pages.Privacy />} /> */}
      <Route path="/new" element={<Pages.NewFile />} />
      <Route path="/share/:type/:data" element={<Pages.ShareProject />} />
      <Route path="/share/expression/:type/:data" element={<Pages.ShareExpression />} />
