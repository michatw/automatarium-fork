...
import { Container } from '../../pages/ShareProject/shareStyle'
...
const ImportDialog = ({ navigateFunction }: ImportDialogProps) => {
  ...
  const onData = (newProject: StoredProject) => {
    const existingProject = projects.find(p => p._id === newProject._id) || newProject._id == newProject._id || false // Looking for existing project to not overwrite it
