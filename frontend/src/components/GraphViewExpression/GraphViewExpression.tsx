...
import { Wrapper, Svg } from './graphViewExpressionStyle'
...
const GraphViewExpression = ({ children, $selectedOnly: $isTemplate = false, ...props }: GraphViewProps) => {
...
export default GraphViewExpression
