...
import { selectionToCopyTemplateProject } from '/src/hooks/useActions'
...
const Templates = () => {
  ...
  const createTemplate = useCallback(() => {
    ...
    const temp = selectionToCopyTemplateProject(selectedStatesIds, selectedCommentsIds, selectedTransitionsIds, project)
    const newTemplate = temp as Template
    // Set template attributes
    newTemplate._id = uuidv4()
