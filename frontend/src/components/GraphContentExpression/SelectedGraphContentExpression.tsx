...
import TransitionSetExpression from '/src/components/TransitionSetExpression/TransitionSetExpression'
...
const SelectedGraphContent = () => {
  ...
  return <>
    ...
    {!!locatedTransitions && locatedTransitions.map((transitions, i) => <TransitionSetExpression
