...
import { useProjectStore, useToolStore, useViewStore, usePreferencesStore, useMetaDataStore, useExpressionStore } from '/src/stores'
...
const useResourceDragging = <T extends RequiredProps>(
  ...
  const commit = type == PROJECT_TYPE? projectState.commit : type == EXPRESSION_TYPE? expressionState.commit : null
