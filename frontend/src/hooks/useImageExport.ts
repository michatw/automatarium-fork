...
import { useExportStore, useMetaDataStore, useProjectStore, useThumbnailStore } from '/src/stores'
...
const useImageExport = () => {
  // At the moment the useImageExport hook is only used for the project type. In the future it should also be implemented for the other types.
