...
import { DEFAULT_PROJECT_COLOR, DEFAULT_STATE_PREFIX_TASK_PROJECT, DEFAULT_OR_OPERATOR, DEFAULT_ACCEPTANCE_CRITERIA, SCHEMA_VERSION, APP_VERSION } from 'frontend/src/config'
import {
  ProjectType,
  Project,
  assertType,
...
export const convertJFLAPProject = (jflapProject: ElementCompact): Project => {
  ...
  return {
    config: {
      ...
      statePrefixSolution: DEFAULT_STATE_PREFIX_TASK_PROJECT,
